export function renderResetPasswordEmail(opts: { actionLink: string; supportUrl: string; year?: number }) {
...
<html lang="en" style="margin:0;padding:0;">
  ...
  <body style="margin:0; padding:0; background:#f7f8fa; -webkit-font-smoothing:antialiased; -moz-osx-font-smoothing:grayscale;">
    <div class="preheader">Use this link to reset your Splittra password.</div>
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="container" style="width:600px; max-width:100%; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 6px 24px rgba(16,24,40,0.06);">
            ...
            <tr>
              <td class="px" style="padding:0 32px;">
                <h2 style="margin:0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif; font-size:24px; line-height:32px; color:#111827; text-align:center;">Reset your password</h2>
                <p style="margin:12px 0 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif; font-size:15px; line-height:24px; color:#4b5563; text-align:center;">We received a request to reset your Splittra password. Click the button below to choose a new one.</p>
              </td>
            </tr>
            <tr>
              <td align="center" style="padding:24px 32px 8px;">
                <a href="${actionLink}" style="display:inline-block; background:linear-gradient(90deg,#16a34a,#059669); color:#ffffff; text-decoration:none; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif; font-weight:600; font-size:15px; line-height:20px; padding:12px 20px; border-radius:10px;">Reset Password</a>
              </td>
            </tr>
            <tr>
              <td class="px" style="padding:8px 32px 24px;">
                ...
                <p style="margin:12px 0 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif; font-size:12px; line-height:20px; color:#9ca3af;">If you didn’t request this, you can safely ignore this email. The link expires soon for security.</p>
              </td>
            </tr>
